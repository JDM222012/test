...
(() => {
  ...
  var NativeCacheModule, NativeFileModule, NativeClientInfoModule, NativeDeviceModule, BundleUpdaterModule, ThemeModule, ImageLoader, NativeThemeModule;
  var init_native = __esm({
    "src/native/index.ts"() {
      "use strict";
      __name(getNativeModule, "getNativeModule");
      NativeCacheModule = __turboModuleProxy("NativeCacheModule");
      NativeFileModule = __turboModuleProxy("NativeFileModule");
      NativeClientInfoModule = __turboModuleProxy("NativeClientInfoModule");
      NativeDeviceModule = __turboModuleProxy("NativeClientInfoModule");
      ...
      NativeThemeModule = __turboModuleProxy("NativeThemeModule");
    }
  });
  ...
  var init_settings = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_api/settings/index.tsx"() {
      init_shared();
      context = getPluginContext("settings");
  ...
  var init_build_info = __esm({
    "build-info:#build-info"() {
      revision = "b1c9af3fcad1b5f8a959f5c6c953b1878144e503";
      branch = "main";
      remote = "C0C0B01/Lumi";
      version = "0.2.4";
    }
  ...
  function getVersions() {
    ...
    var rnVer = import_react_native6.Platform.constants.reactNativeVersion;
  ...
  var import_react4, import_react_native6;
  var init_info = __esm({
    "src/debug/info.ts"() {
      "use strict";
      init_build_info();
  ...
  var MagnifyingGlassIcon, CirclePlusIcon, CircleMinusIcon, ArrowSmallLeftIcon, ActivitiesIcon, WrenchIcon, DownloadIcon, PuzzlePieceIcon, CircleInformationIcon, CircleCheckIcon, WarningIcon, PaintPaletteIcon;
  ...
  function PageWrapper(props) {
    ...
    if (props.scrollable) {
      node = /* @__PURE__ */ jsx(import_react_native7.ScrollView, {
        contentContainerStyle: containerStyle,
        children: node
      });
    } else {
      node = /* @__PURE__ */ jsx(import_react_native7.View, {
        style: [
          {
            flex: 1,
            maxHeight: height
  ...
  function InfoCard({ title, style, icon, tag, onPress, trailing }) {
    return /* @__PURE__ */ jsx(Card_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native8.View, {
        ...
        children: [
          tag && /* @__PURE__ */ jsx(import_react_native8.View, {
            style: {
              position: "absolute",
              top: -28,
              right: -18
  ...
  var import_react_native9, import_react5;
...
${log.errorStack}`;
  ...
  function LogsPage() {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      children: /* @__PURE__ */ jsx(import_flash_list.FlashList, {
        data: filteredLogs,
  ...
  var import_flash_list, import_react6, import_react_native14;
  var init_Logs = __esm({
    "src/components/Wintry/Settings/pages/Logs/index.tsx"() {
      "use strict";
      init_jsxRuntime();
...
(${discord.build})`,
        ...
        /* @__PURE__ */ jsxs(TableRowGroup_default, {
          ...
          children: [
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native16.Linking.openURL(`https://${Links.GITHUB}`), "onPress")
            }),
            /* @__PURE__ */ jsx(TableRow_default, {
              ...
              onPress: /* @__PURE__ */ __name(() => import_react_native16.Linking.openURL(`https://${Links.DISCORD}`), "onPress")
            })
          ]
        })
      ]
  ...
  var import_react_native15, import_react_native16;
  ...
  var import_react_native17, CALLOUT_VARIANT_CONFIG;
  ...
  function ResponsiveMasonryFlashList(props) {
    ...
    var dimensions = (0, import_react_native18.useWindowDimensions)();
    var listProps = (0, import_react7.useMemo)(() => omit(props, [
      "data",
      "renderItem"
    ]), [
      props
    ]);
    var numColumns = (0, import_react7.useMemo)(() => Math.min(props.data.length, Math.floor((dimensions.width - 24) / minWidth)), [
      dimensions.width,
      props.data,
      minWidth
    ]);
    var renderItem = (0, import_react7.useCallback)((info) => {
    ...
    return /* @__PURE__ */ jsx(import_flash_list2.MasonryFlashList, {
      data: props.data,
      numColumns,
      renderItem,
      ...listProps
  ...
  var import_react7, import_react_native18, import_flash_list2;
  ...
  function HighlightProvider({ children, result, searchTerms }) {
    var contextValue = (0, import_react8.useMemo)(() => ({
      result,
      searchTerms
    }), [
      result,
  ...
  function useHighlight() {
    var context19 = (0, import_react8.useContext)(HighlightContext);
    if (!context19) {
  ...
  function useHighlightedSearchTerm(index) {
    ...
    return (0, import_react8.useCallback)((textProps) => {
  ...
  var import_react8, HighlightContext;
  var init_SearchTermHighlight = __esm({
    "src/components/Wintry/Settings/pages/Addon/SearchTermHighlight.tsx"() {
      ...
      HighlightContext = /* @__PURE__ */ (0, import_react8.createContext)(null);
  ...
  function AddonPage(props) {
    ...
    return /* @__PURE__ */ jsx(PageWrapper, {
      ...
      children: /* @__PURE__ */ jsx(ResponsiveMasonryFlashList, {
        ...
        ListHeaderComponent: /* @__PURE__ */ jsxs(import_react_native20.View, {
          style: {
            gap: 8
          },
          children: [
  ...
  var import_react_native20, ItemSeparator;
  var init_Addon = __esm({
    "src/components/Wintry/Settings/pages/Addon/index.tsx"() {
      ...
      init_SearchTermHighlight();
      init_loader();
      ItemSeparator = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsx(import_react_native20.View, {
        style: {
          height: 8
        }
      }), "ItemSeparator");
  ...
  function useSearchQuery() {
    var [q, setQ] = (0, import_react9.useState)("");
    var ref = {
      query: q,
      __set: setQ
    };
  ...
  var import_react9, import_react_native21, Search_default;
  var init_Search = __esm({
    "src/components/Wintry/Search.tsx"() {
      ...
      Search_default = /* @__PURE__ */ __name(({ onChangeText, placeholder, style, isRound, queryRef }) => {
        var [query, setQuery] = (0, import_react9.useState)(queryRef?.query ?? "");
  ...
  var import_react_native23, showUserProfileActionSheet, useStyles2, maybeFetchUser;
  ...
  function useShallow(selector) {
    var prev = import_react10.default.useRef();
    return (state2) => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(import_react_native25.View, {
          ...
          children: /* @__PURE__ */ jsx(Slider_default, {
            ...
            startIcon: /* @__PURE__ */ jsx(import_react_native25.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex - 1), "onPress"),
              children: /* @__PURE__ */ jsx(CircleMinusIcon, {})
            }),
            endIcon: /* @__PURE__ */ jsx(import_react_native25.Pressable, {
              onPress: /* @__PURE__ */ __name(() => updateValue(currentIndex + 1), "onPress"),
  ...
  function OptionSection({ plugin }) {
    ...
    return /* @__PURE__ */ jsx(InfoSection, {
      ...
      children: /* @__PURE__ */ jsx(import_react_native26.View, {
        ...
        children: options.map((group, i2) => /* @__PURE__ */ jsx(import_react_native26.View, {
          children: group.map(([key, opt], i3) => /* @__PURE__ */ jsx(import_react_native26.View, {
  ...
  var init_parser = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/painter/parser.ts"() {
      init_shared();
      context2 = getPluginContext("painter");
  ...
  function parseColorManifest(manifest) {
    ...
    for (var [semanticColorKey, semanticColorValue] of Object.entries(manifest.main.colors.semantic ?? {})) {
      ...
      if (value[0] === "#") {
        ...
        if (!rawColorValue) {
          logger5.warn(`Unknown raw color reference: ${value}`);
          continue;
        }
        semanticColorDefinitions[semanticColorKey] = {
          value: rawColorValue,
  ...
  function maybeApplyAndroidExtraKeys(rawColors) {
    if (import_react_native28.Platform.OS !== "android") return rawColors;
    if (!rawColors) return {};
    var copy = {
      ...rawColors
    };
  ...
  var import_react_native28, tokensModule, determineColorReference;
  ...
  // src/plugins/_core/painter/themes/Chadpuccin Mocha.ts
  var MOCHA_THEME;
  var init_Chadpuccin_Mocha = __esm({
    "src/plugins/_core/painter/themes/Chadpuccin Mocha.ts"() {
      "use strict";
      MOCHA_THEME = {
        id: "chadpuccin.mocha",
  ...
  // src/plugins/_core/painter/themes/Rosie Pink.ts
  var ROSIE_PINK_THEME;
  var init_Rosie_Pink = __esm({
    "src/plugins/_core/painter/themes/Rosie Pink.ts"() {
      "use strict";
      ROSIE_PINK_THEME = {
        id: "rosie.pink",
  ...
  // src/plugins/_core/painter/themes/Eye Candy.ts
  var EYE_CANDY_THEME;
  var init_Eye_Candy = __esm({
    "src/plugins/_core/painter/themes/Eye Candy.ts"() {
      "use strict";
      EYE_CANDY_THEME = {
        id: "eye.candy",
  ...
  // src/plugins/_core/painter/themes/Clear Vision.ts
  var CLEAR_VISION_THEME;
  var init_Clear_Vision = __esm({
    "src/plugins/_core/painter/themes/Clear Vision.ts"() {
      "use strict";
      CLEAR_VISION_THEME = {
        id: "clear.vision",
  ...
  var Themes, logger6, formDividerModule, tokenRefModule, UserSettingsActionCreators, _inc, useThemeStore;
  var init_useThemeStore = __esm({
    "src/plugins/_core/painter/useThemeStore.ts"() {
      ...
      logger6 = wtlogger.createChild("ThemeStore");
  ...
  // src/components/Wintry/Settings/pages/Themes/TitleComponent.tsx
  ...
  var import_react_native29, showUserProfileActionSheet2, useStyles3, maybeFetchUser2;
  ...
  // src/components/Wintry/Settings/pages/Themes/common/index.tsx
  var common_exports2 = {};
  ...
  // src/components/Wintry/Settings/pages/Themes/ThemeDetailsSheet.tsx
  ...
  // src/components/Wintry/Settings/pages/Themes/SheetAwareIconButton.tsx
  ...
  // src/components/Wintry/Settings/pages/Themes/ThemeSheetComponent.tsx
  ...
  var import_react11, import_react_native31, import_flash_list3, IMAGE_TYPES, DEFAULT_IMAGE_SIZE, isAssetTypeAnImage, BasicAssetDisplay, ImageAssetDisplay, AssetDisplay, ImageAssetPreviewer, sortAssets;
  var init_AssetBrowser = __esm({
    "src/components/Wintry/Settings/pages/Developer/AssetBrowser.tsx"() {
      ...
      ImageAssetDisplay = /* @__PURE__ */ __name(({ asset, start, end }) => /* @__PURE__ */ jsx(TableRow_default, {
        ...
        trailing: /* @__PURE__ */ jsx(import_react_native31.Image, {
          source: asset.id,
          style: {
      ...
      ImageAssetPreviewer = /* @__PURE__ */ __name(({ asset }) => {
        var width = (0, import_react_native31.useWindowDimensions)().width - 24;
        var imageSize = {
  ...
  function ColorRow({ token, start, end }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      trailing: /* @__PURE__ */ jsx(import_react_native32.View, {
        style: {
          width: 24,
          height: 24,
          borderRadius: 4,
  ...
  var import_flash_list4, import_react_native32;
  ...
  function ToastPlayground() {
    var [toastConfig, setToastConfig] = (0, import_react12.useState)({
      id: "toast-demo",
    ...
    var handleShowToast = /* @__PURE__ */ __name(() => {
      var options = {
        ...
        onDismiss() {
          logger7.info("Toast dismissed");
        },
        onPress() {
          logger7.info("Toast pressed");
        },
        onTimeout() {
          logger7.info("Toast timed out");
        }
      };
          ...
          /* @__PURE__ */ jsx(RowButton_default, {
            ...
            onPress: /* @__PURE__ */ __name(() => {
              var toast = showToast({
                id: "loading-toast",
                text: "Loading...",
                icon: /* @__PURE__ */ jsx(import_react_native33.ActivityIndicator, {}),
                dismissible: false
              });
              setTimeout(() => {
                toast.update({
  ...
  var import_react12, import_react_native33, logger7;
  var init_ToastPlayground = __esm({
    "src/components/Wintry/Settings/pages/Developer/ToastPlayground.tsx"() {
      ...
      logger7 = wtlogger.createChild("ToastPlayground");
  ...
  var import_react14, settings, settings_default;
          ...
          },
          {
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "default", (_, ret) => {
                ...
                if (!props) {
                  logger4.warn("Failed to find settings sections in SettingsOverviewScreen");
                  return;
                }
                if (!settings.get().onTop) {
                  try {
                    ...
                    logger4.warn`Failed to insert settings sections next to account section: ${e3}`;
                  }
                }
                props.sections = [
                  ..._registeredSettingSections,
          ...
          setImmediate(() => {
            registerSettingRenderer("LUMI_CUSTOM_PAGE", {
              ...
              screen: {
                ...
                getComponent: memoize(() => /* @__PURE__ */ (0, import_react14.memo)(() => {
                  var navigation = NavigationNative.useNavigation();
                  var route = NavigationNative.useRoute();
                  var { render: PageComponent, ...args } = route.params;
                  (0, import_react14.useLayoutEffect)(() => void navigation.setOptions({
                    ...args
                  }), [
                    navigation
                  ]);
  ...
  var init_toasts2 = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_api/toasts/index.tsx"() {
      init_shared();
      context3 = getPluginContext("toasts");
  ...
  function ToastIcon({ icon }) {
    ...
    if (typeof icon === "number" || typeof icon === "object" && "uri" in icon) {
      return /* @__PURE__ */ jsx(import_react_native34.Image, {
        style: {
          width: 18,
          height: 18
        },
  ...
  var import_react15, import_react_native34;
  ...
  var init_Toast = __esm({
    "src/plugins/_api/toasts/components/Toast.tsx"() {
      ...
      _worklet_10575445024011_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx1","translationX","translationY","__closure","transform","translateX","value","translateY"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAwC0C,SAAAA,UAAA,QAAAC,YAAA,CAAAC,YAAA,OAAAC,SAAA,OAAK,CACnCC,SAAS,CAAE,CACP,CACIC,UAAU,CAAEJ,YAAY,CAACK,KAC7B,CAAC,CACD,CACIC,UAAU,CAAEL,YAAY,CAACI,KAC7B,CAAC,CAET,CAAC","ignoreList":[]}',
        version: "0.3.0"
      };
      _worklet_12707892542287_init_data = {
      ...
      _worklet_2394815801719_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx3","event","translationX","__closure","value","changeX"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDwG,SAAAA,SAAQA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,CACxGD,YAAY,CAACE,KAAK,EAAIH,KAAK,CAACI,OAAO,CACvC","ignoreList":[]}',
        version: "0.3.0"
      };
      _worklet_1148071943580_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx4","e","translationX","__closure","value"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAyDqD,QAAC,CAAAA,UAAAC,CAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAIH,CAAC,CAAAC,YAAA","ignoreList":[]}',
        version: "0.3.0"
      };
      _worklet_12633554293434_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx5","finished","willDisappear","runOnJS","onceOnDismiss","__closure"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AA+D8D,SAAAA,UAAQC,QAAG,QAAAC,aAAA,CAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CAC7D,GAAIJ,QAAQ,EAAIC,aAAa,CAAE,CAC3BC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "0.3.0"
      };
      ...
      _worklet_3070931472053_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx7","event","translationY","__closure","value","y"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAqEuG,SAAAA,SAAKA,CAAAC,KAAA,QAAAC,YAAA,OAAAC,SAAA,OAAG,CAAAD,YAAa,CAAAE,KAAK,CAAGH,KAAM,CAAAI,CAAA","ignoreList":[]}',
        version: "0.3.0"
      };
      _worklet_1700014798715_init_data = {
        ...
        location: "/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx",
        sourceMap: '{"version":3,"names":["ToastTsx8","finished","runOnJS","onceOnDismiss","__closure"],"sources":["/home/cocobo1/StudioProjects/Lumi/src/plugins/_api/toasts/components/Toast.tsx"],"mappings":"AAuEuE,SAAAA,UAAQC,QAAG,QAAAC,OAAA,CAAAC,aAAA,OAAAC,SAAA,CACtE,GAAIH,QAAQ,CAAE,CACVC,OAAO,CAACC,aAAa,CAAC,CAAC,CAAC,CAC5B,CACJ","ignoreList":[]}',
        version: "0.3.0"
      };
      Toast_default = /* @__PURE__ */ (0, import_react16.memo)(/* @__PURE__ */ __name(function Toast({
        ...
        var {
          width
        } = (0, import_react_native35.useWindowDimensions)();
        ...
        var animatedStyles = (0, import_react_native_reanimated.useAnimatedStyle)((/* @__PURE__ */ __name(function ToastTsx1Factory({
          _worklet_10575445024011_init_data: _worklet_10575445024011_init_data2,
          ...
          ToastTsx1.__initData = _worklet_10575445024011_init_data2;
        ...
        var pan = import_react_native_gesture_handler.Gesture.Pan().minDistance(20).onStart((/* @__PURE__ */ __name(function ToastTsx4Factory({
          _worklet_1148071943580_init_data: _worklet_1148071943580_init_data2,
          translationX: translationX2
        }) {
          var _e = [new globalThis.Error(), -2, -27];
          var ToastTsx4 = /* @__PURE__ */ __name((e3) => translationX2.value = e3.translationX, "ToastTsx4");
          ToastTsx4.__closure = {
            translationX: translationX2
          };
          ToastTsx4.__workletHash = 1148071943580;
          ToastTsx4.__initData = _worklet_1148071943580_init_data2;
          ToastTsx4.__stackDetails = _e;
          return ToastTsx4;
        }, "ToastTsx4Factory"))({
          _worklet_1148071943580_init_data,
          translationX
        })).onChange((/* @__PURE__ */ __name(function ToastTsx3Factory({
          _worklet_2394815801719_init_data: _worklet_2394815801719_init_data2,
          translationX: translationX2
        }) {
          var _e = [new globalThis.Error(), -2, -27];
          var ToastTsx3 = /* @__PURE__ */ __name(function(event) {
            translationX2.value += event.changeX;
          }, "ToastTsx3");
          ToastTsx3.__closure = {
            translationX: translationX2
          };
          ToastTsx3.__workletHash = 2394815801719;
          ToastTsx3.__initData = _worklet_2394815801719_init_data2;
          ToastTsx3.__stackDetails = _e;
          return ToastTsx3;
        }, "ToastTsx3Factory"))({
          _worklet_2394815801719_init_data,
          translationX
        })).onEnd((/* @__PURE__ */ __name(function ToastTsx2Factory({
          _worklet_12707892542287_init_data: _worklet_12707892542287_init_data2,
          toast: toast2,
          translationX: translationX2,
          width: width2,
          OFFSCREEN_LENGTH: OFFSCREEN_LENGTH2,
          withTiming: withTiming2,
          runOnJS: runOnJS2,
          onceOnDismiss: onceOnDismiss2
        }) {
          var _e = [new globalThis.Error(), -8, -27];
          var ToastTsx2 = /* @__PURE__ */ __name(function() {
            var willDisappear = toast2.dismissible && (translationX2.value > width2 / 4 || translationX2.value < -width2 / 4);
            var direction = Math.sign(translationX2.value);
            var position = willDisappear ? OFFSCREEN_LENGTH2 * direction : 0;
            translationX2.value = withTiming2(position, void 0, (/* @__PURE__ */ __name(function ToastTsx5Factory({
              _worklet_12633554293434_init_data: _worklet_12633554293434_init_data2,
              willDisappear: willDisappear2,
              runOnJS: runOnJS3,
              onceOnDismiss: onceOnDismiss3
            }) {
              var _e2 = [new globalThis.Error(), -4, -27];
              var ToastTsx5 = /* @__PURE__ */ __name(function(finished) {
                if (finished && willDisappear2) {
                  runOnJS3(onceOnDismiss3)();
                }
              }, "ToastTsx5");
              ToastTsx5.__closure = {
                willDisappear: willDisappear2,
              ...
              ToastTsx5.__initData = _worklet_12633554293434_init_data2;
          ...
          ToastTsx2.__initData = _worklet_12707892542287_init_data2;
        ...
        var fling = import_react_native_gesture_handler.Gesture.Fling().simultaneousWithExternalGesture(pan).direction(import_react_native_gesture_handler.Directions.UP).onStart((/* @__PURE__ */ __name(function ToastTsx7Factory({
          _worklet_3070931472053_init_data: _worklet_3070931472053_init_data2,
          translationY: translationY2
        }) {
          var _e = [new globalThis.Error(), -2, -27];
          var ToastTsx7 = /* @__PURE__ */ __name((event) => translationY2.value = event.y, "ToastTsx7");
          ToastTsx7.__closure = {
            translationY: translationY2
          };
          ToastTsx7.__workletHash = 3070931472053;
          ToastTsx7.__initData = _worklet_3070931472053_init_data2;
          ToastTsx7.__stackDetails = _e;
          return ToastTsx7;
        }, "ToastTsx7Factory"))({
          _worklet_3070931472053_init_data,
          translationY
        })).onEnd((/* @__PURE__ */ __name(function ToastTsx6Factory({
          _worklet_14643467246605_init_data: _worklet_14643467246605_init_data2,
          toast: toast2,
          translationY: translationY2,
          withTiming: withTiming2,
          OFFSCREEN_LENGTH: OFFSCREEN_LENGTH2,
          ...
          var ToastTsx6 = /* @__PURE__ */ __name(function() {
            ...
            translationY2.value = withTiming2(-OFFSCREEN_LENGTH2, void 0, (/* @__PURE__ */ __name(function ToastTsx8Factory({
              _worklet_1700014798715_init_data: _worklet_1700014798715_init_data2,
              runOnJS: runOnJS3,
              onceOnDismiss: onceOnDismiss3
            }) {
              ...
              ToastTsx8.__initData = _worklet_1700014798715_init_data2;
          ...
          ToastTsx6.__initData = _worklet_14643467246605_init_data2;
          ...
          children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
            ...
            children: /* @__PURE__ */ jsx(PressableScale_default, {
              ...
              children: /* @__PURE__ */ jsx(import_react_native_reanimated.default.View, {
                ...
                children: /* @__PURE__ */ jsx(import_react_native35.View, {
  ...
  var import_react_native36, isDiscordToastActive;
  ...
  var init_error_boundary = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/error-boundary/index.tsx"() {
      init_shared();
      context4 = getPluginContext("error-boundary");
    ...
    return /* @__PURE__ */ jsxs(import_react_native37.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(Button_default, {
          ...
          icon: /* @__PURE__ */ jsx(import_react_native37.Image, {
            resizeMode: "contain",
      ...
      children: /* @__PURE__ */ jsxs(import_react_native38.View, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(import_react_native38.View, {
            ...
            children: stack.map((component, index) => /* @__PURE__ */ jsxs(import_react_native38.View, {
              style: {
                flexDirection: "row"
              },
              children: [
  ...
  var import_react17, import_react_native38;
  ...
  function ErrorStackCard(props) {
    var [collapsed, setCollapsed] = (0, import_react18.useState)(true);
    var stack;
    try {
  ...
  function Line(props) {
    var [collapsed, setCollapsed] = (0, import_react18.useState)(true);
    return /* @__PURE__ */ jsxs(import_react_native39.Pressable, {
      onPress: /* @__PURE__ */ __name(() => setCollapsed((v) => !v), "onPress"),
      children: [
        /* @__PURE__ */ jsx(Text_default, {
          style: {
  ...
  var import_react18, import_react_native39;
  ...
  var import_react_native40, useStyles5;
  ...
  var init_error_boundary2 = __esm({
    "src/plugins/_core/error-boundary/index.tsx"() {
      ...
      init_wrappers();
      error_boundary_default = definePlugin4({
        name: "ErrorBoundary",
        ...
        start() {
          ...
          patcher4.after.async(jsxRuntime2, "jsx", callback);
          patcher4.after.async(jsxRuntime2, "jsxs", callback);
        }
      });
    }
  });
  ...
  var init_no_track = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/no-track/index.ts"() {
      init_shared();
      context5 = getPluginContext("no-track");
  ...
  var init_no_track2 = __esm({
    "src/plugins/_core/no-track/index.ts"() {
      ...
      init_filters2();
      init_no_track();
      no_track_default = definePlugin5({
        name: "NoTrack",
  ...
  var init_dummy = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/dummy/index.ts"() {
      init_shared();
      context6 = getPluginContext("dummy");
  ...
  var init_dummy2 = __esm({
    "src/plugins/_core/dummy/index.ts"() {
      ...
      init_constants();
      init_filters2();
      settings2 = definePluginSettings6({
        bunnyName: {
          type: "string",
          label: "Bunny Name",
  ...
  var init_painter_plus = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/painter-plus/index.tsx"() {
      init_shared();
      context7 = getPluginContext("painter-plus");
  ...
  var init_resolver = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/painter/patches/resolver.ts"() {
      init_shared();
      context8 = getPluginContext("painter");
  ...
  var init_stores2 = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/_core/painter/patches/stores.ts"() {
      init_shared();
      context9 = getPluginContext("painter");
  ...
  function patchSelectivelySyncedUserSettingsStore() {
    ...
    patcher9.after(SelectivelySyncedUserSettingsStore, "getState", (_, ret) => {
    ...
    patcher9.instead(SelectivelySyncedUserSettingsStore, "persist", (_, orig) => {
      isPersisting = true;
      try {
        orig();
      } finally {
  ...
  function patchDefinitionAndResolver() {
    ...
    patcher8.before(isThemeModule, "isThemeDark", callback);
    patcher8.before(isThemeModule, "isThemeLight", callback);
    patcher8.before(getNativeModule("NativeThemeModule"), "updateTheme", callback);
    patcher8.instead(tokensModule2.default.internal, "resolveSemanticColor", (args, orig) => {
  ...
  var tokensModule2, isThemeModule;
  ...
  var painter_plus_default, PatchType, InactiveReason, ConfigIconpackMode, enabled;
  var init_painter_plus2 = __esm({
    "src/plugins/_core/painter-plus/index.tsx"() {
      ...
      init_resolver2();
      init_stores3();
      painter_plus_default = definePlugin7({
        name: "Painter Plus",
  ...
  var init_painter2 = __esm({
    "src/plugins/_core/painter/index.ts"() {
      ...
      init_stores3();
      init_useThemeStore();
      painter_default = definePlugin10({
        name: "Painter",
      ...
      chat_bubbles_default = definePlugin11({
        ...
        start() {
          ...
          var updateBubbleAppearance = /* @__PURE__ */ __name(() => {
            ...
            BubbleModule_default.configure(avatarRadius, bubbleChatRadius, color).catch(logger16.error);
...
${inspect({
  ...
  var init_expression_utils = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/index.tsx"() {
      init_shared();
      context14 = getPluginContext("expression-utils");
  ...
  function UploadStatusView() {
    ...
    return /* @__PURE__ */ jsxs(import_react_native_reanimated2.default.View, {
      ...
      style: styles.container,
      children: [
        status === "pending" && /* @__PURE__ */ jsxs(import_react_native42.View, {
          style: styles.rowContainer,
          children: [
            /* @__PURE__ */ jsx(import_react_native42.ActivityIndicator, {
              size: "small"
            }),
            /* @__PURE__ */ jsx(Text_default, {
              variant: "text-lg/semibold",
        ...
        status === "success" && /* @__PURE__ */ jsxs(import_react_native42.View, {
          style: styles.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native42.View, {
              style: styles.rowContainer,
              children: [
                /* @__PURE__ */ jsx(import_react_native42.Image, {
            ...
            emojiNode && /* @__PURE__ */ jsxs(import_react_native42.View, {
              style: styles.rowContainer,
              children: [
        ...
        status === "error" && error != null && /* @__PURE__ */ jsxs(import_react_native42.View, {
          style: styles.centeredContainer,
          children: [
            /* @__PURE__ */ jsxs(import_react_native42.View, {
              style: styles.rowContainer,
  ...
  var import_react_native42, import_react_native_reanimated2, useStyles6;
  ...
  var import_react19, getMaxEmojiSlots;
  ...
  function ServerRow({ start, end, guild, emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(TableRow_default, {
      ...
      onPress: /* @__PURE__ */ __name(() => {
        import_react_native43.Keyboard.dismiss();
  ...
  function EmoteStealerActionSheet({ emojiNode }) {
    ...
    return /* @__PURE__ */ jsx(BottomSheet_default, {
      ...
      children: /* @__PURE__ */ jsxs(import_react_native44.ScrollView, {
        style: {
          gap: 12
        },
        children: [
          ...
          /* @__PURE__ */ jsx(import_flash_list5.FlashList, {
            ...
            ListHeaderComponent: /* @__PURE__ */ jsx(import_react_native44.View, {
              style: {
                gap: 12,
                paddingVertical: 12
              },
  ...
  var import_react_native44, import_flash_list5;
  ...
  function getSizeAsync(src) {
    return new Promise((resolve, reject) => {
      import_react_native46.Image.getSize(src, (width, height) => {
        resolve([
          width,
          height
        ]);
  ...
  function _openMediaModal() {
    _openMediaModal = _async_to_generator(function* (src) {
      ...
      var { width: screenWidth, height: screenHeight } = import_react_native46.Dimensions.get("window");
  ...
  var init_openEmojiActionSheet = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/expression-utils/utils/openEmojiActionSheet.tsx"() {
      init_shared();
      context15 = getPluginContext("expression-utils");
  ...
  function openEmojiActionSheet({ id, name, animated }) {
    try {
      ...
      logger20.error(`Failed to open emoji action sheet: ${err}`);
    }
  }
  ...
  var import_react20, expression_utils_default;
  var init_expression_utils2 = __esm({
    "src/plugins/expression-utils/index.tsx"() {
      ...
      expression_utils_default = definePlugin14({
            ...
            patch(module3, patcher19) {
              patcher19.after(module3, "MessageReactionsContent", (_, { props }) => {
                var unpatchReactionsHeader = patcher19.detached.after(props.header, "type", (_2, res) => {
                  (0, import_react20.useEffect)(() => unpatchReactionsHeader, []);
                  try {
                    ...
                    logger19.error`Failed to patch reaction header: ${e3}`;
                  }
                });
              });
            }
        ...
        start() {
          patcher14.attachDisposer(useEmojiAdderStore.subscribe((s, p2) => {
  ...
  // plugins-context-provider:#plugin-context#src/plugins/dashless/index.ts
  var context16, meta16, definePlugin16, definePluginSettings16, logger21, patcher16;
  var init_dashless = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/dashless/index.ts"() {
      init_shared();
      context16 = getPluginContext("dashless");
  ...
  var View35, traverseAndModify, unpatchRender, dashless_default;
  var init_dashless2 = __esm({
    "src/plugins/dashless/index.ts"() {
      "use strict";
      init_libraries();
      init_patcher2();
      ...
      dashless_default = definePlugin16({
        name: "Dashless",
        ...
        start() {
          unpatchRender = after(View35, "render", (_, res) => {
  ...
  // plugins-context-provider:#plugin-context#src/plugins/freecons/index.ts
  var context17, meta17, definePlugin17, definePluginSettings17, logger22, patcher17;
  var init_freecons = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/freecons/index.ts"() {
      init_shared();
      context17 = getPluginContext("freecons");
  ...
  // src/plugins/freecons/index.ts
  var freecons_exports = {};
  __export(freecons_exports, {
    default: () => freecons_default
  });
  var icons, iconsIds, freecons_default;
  var init_freecons2 = __esm({
    "src/plugins/freecons/index.ts"() {
      "use strict";
      init_filters2();
      init_constants();
  ...
  var init_always_trust = __esm({
    "plugins-context-provider:#plugin-context#src/plugins/always-trust/index.ts"() {
      init_shared();
      context18 = getPluginContext("always-trust");
  ...
  var init_always_trust2 = __esm({
    "src/plugins/always-trust/index.ts"() {
      ...
      init_always_trust();
      init_stores();
      always_trust_default = definePlugin18({
        name: "Always Trust",
        ...
        patches: [
          {
            ...
            patch(module3, patcher19) {
              patcher19.instead(module3, "isTrustedDomain", () => true);
            }
          }
        ]
      });
  ...
  // plugins-importer:/home/cocobo1/StudioProjects/Lumi/src/plugins
  var plugins_exports = {};
  __export(plugins_exports, {
  ...
  var init_plugins = __esm({
    "plugins-importer:/home/cocobo1/StudioProjects/Lumi/src/plugins"() {
      plugins_default = {
        ...
        "dashless": (init_dashless2(), __toCommonJS(dashless_exports)).default("/dashless"),
        "freecons": (init_freecons2(), __toCommonJS(freecons_exports)).default("/freecons"),
  ...
  function applyPluginPatches(id, plugin) {
    var _loop = /* @__PURE__ */ __name(function(pluginPatch2) {
      ...
      var apply = /* @__PURE__ */ __name(() => {
        logger24.debug(`Applying ${patcher19.id} patch`);
        patcher19.reuse();
      ...
      if (settings4 && pluginPatch2.predicate) {
        ...
        var unsub = settings4.subscribe(() => predicate(), () => {
          if (predicate()) {
            ...
            logger24.debug(`Disposing ${patcher19.id} patch`);
            patcher19.dispose();
          }
        }, {
  ...
  var init_usePluginStore = __esm({
    "src/stores/usePluginStore.ts"() {
      ...
      init_modules();
      init_utils2();
      logger24 = wtlogger.createChild("PluginStore");
  ...
  // src/components/Wintry/Settings/pages/Themes/options/BaseCardOption.tsx
  ...
  // src/components/Wintry/Settings/pages/Themes/common/getIcon.tsx
  ...
  var init_globals = __esm({
    "modules-exposer:#globals#"() {
      ...
      globals_default = {
        ...
        "components/Wintry/Settings/pages/Themes/ThemeDetailsSheet": createModuleProxy(() => (init_ThemeDetailsSheet(), __toCommonJS(ThemeDetailsSheet_exports))),
        "components/Wintry/Settings/pages/Themes/ThemeSheetComponent": createModuleProxy(() => (init_ThemeSheetComponent(), __toCommonJS(ThemeSheetComponent_exports))),
        "components/Wintry/Settings/pages/Themes/SheetAwareIconButton": createModuleProxy(() => (init_SheetAwareIconButton2(), __toCommonJS(SheetAwareIconButton_exports2))),
        "components/Wintry/Settings/pages/Themes/TitleComponent": createModuleProxy(() => (init_TitleComponent2(), __toCommonJS(TitleComponent_exports2))),
        "components/Wintry/Settings/pages/Themes/options/BaseCardOption": createModuleProxy(() => (init_BaseCardOption2(), __toCommonJS(BaseCardOption_exports2))),
        "components/Wintry/Settings/pages/Themes/common/": createModuleProxy(() => (init_common2(), __toCommonJS(common_exports2))),
        "components/Wintry/Settings/pages/Themes/common/getIcon": createModuleProxy(() => (init_getIcon2(), __toCommonJS(getIcon_exports2))),
