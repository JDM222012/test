  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        ASSET_BROWSER: "Goon Browser",
        BRAND: "Goonrand",
        BUNNY: "GoonCord\u{1F4A6}\u{1F4A6}",
        BUNNY_URL: "GoonCord URL",
        BYTECODE: "Bytecode",
        CANCEL: "Cancel",
        CLEAR: "Clear",
        CLEAR_BUNDLE: "Clear CUM Bundle",
        ...
        CODENAME: "Codename",
        COMMAND_DEBUG_DESC: "Send cumbug cumformation\u{1F4A6}",
        ...
        CONTINUE: "Continue",
        COPIED_TO_CLIPBOARD: "Copied to cumboard",
        COPY_URL: "Copy URL",
        DEBUG: "Cumbug",
        DEBUGGER_URL: "Cumbugger URL",
        DELETE: "Delete",
        DESC_EXTRACT_FONTS_FROM_THEME: 'Looks out for "fonts" field in your currently applied theme and install it.',
        DEVELOPER: "Goonmveloper\u{1F4A6}",
        DEVELOPER_SETTINGS: "Cumveloper Sementings",
        DISABLE_THEME: "Disable Theme",
        DISABLE_UPDATES: "Disable Updates",
        DISCORD_SERVER: "Gooncord Semen\u{1F4A6}",
        DONE: "Done",
        ENABLE_EVAL_COMMAND: "Enable /eval cummand",
        ENABLE_EVAL_COMMAND_DESC: "Unbound Kinda ass but as always Bound wins. W Cumcord fr \u{1F525}",
        ENABLE_UPDATES: "Enable Updates",
        ERROR_BOUNDARY_TOOLS_LABEL: "ErrorBoundary Tools",
        EXTRACT: "Extract semen",
        FONT_NAME: "Font Name",
        FONTS: "Fonts",
        GENERAL: "General",
        GITHUB: "GoonHub\u{1F4A6}",
        HOLD_UP: "Hold Up",
        INFO: "Info",
        INSTALL: "Install",
        ...
        INSTALL_REACT_DEVTOOLS: "Install Cumact CumTools",
        INSTALL_THEME: "Install a theme",
        LABEL_EXTRACT_FONTS_FROM_THEME: "Extract semen from theme",
        LINKS: "Links",
        LOAD_FROM_CUSTOM_URL: "Load from cumtom URL",
        LOAD_FROM_CUSTOM_URL_DEC: "Load CumCord from a custom endpoint",
        LOAD_REACT_DEVTOOLS: "Load Cumact CumTools",
        LOADER: "Cummer",
        MACHINE_ID: "Machine ID",
        MANUFACTURER: "Manufacturer",
        MESSAGE: "Message",
        MISCELLANEOUS: "Miscellaneous",
        MODAL_RELOAD_REQUIRED: "Orgasm app?",
        ...
        MODEL: "Goon\u{1F4A6}",
        OPEN_IN_BROWSER: "Goon in Browser?",
        OPERATING_SYSTEM: "Cumerating System",
        OVERFLOW_PLUGIN_SETTINGS: "Plugin Settings",
        PLATFORM: "Goonform\u{1F4A6}",
        PLUGIN_REFETCH_FAILED: "Failed to orgasm plugin",
        PLUGIN_REFETCH_SUCCESSFUL: "Successfully cummed plugin",
        PLUGINS: "Cumins",
        REFETCH: "Orgasm\u{1F4A6}",
        RELOAD: "Goonload",
        RELOAD_DISCORD: "Goonload Discord",
        RELOAD_IN_NORMAL_MODE: "Cumload in Normal Mode",
        RELOAD_IN_NORMAL_MODE_DESC: "CUM\u{1F4A6} mode currently enabled, tap to reload in normal mode",
        RELOAD_IN_SAFE_MODE: "CUM\u{1F4A6} in Safe Mode",
        ...
        SAFE_MODE: "Goon\u{1F4A6} Mode",
        SAFE_MODE_NOTICE_FONTS: "You are in Gonner\u{1F4A6} mode, meaning fonts have been temporarily disabled. {enabled, select, true {If a font appears to be causing the issue, you can press below to disable it persistently.} other {}}",
        SAFE_MODE_NOTICE_PLUGINS: "You are in Gonner\u{1F4A6} mode, so plugins cannot be loaded. Disable any misbehaving plugins, then return to Normal Mode from the General settings page.",
        SAFE_MODE_NOTICE_THEMES: "You are in Gooner\u{1F4A6} mode, meaning themes have been temporarily disabled. {enabled, select, true {If a theme appears to be causing the issue, you can press below to disable it persistently.} other {}}",
        SEARCH: "Search",
        SEPARATOR: ", ",
        SETTINGS_ACTIVATE_DISCORD_EXPERIMENTS: "Activate GonnerCord\u{1F4A6} Cumperiments",
        SETTINGS_ACTIVATE_DISCORD_EXPERIMENTS_DESC: "Warning: Cumming with this feature may lead to account termination. We are not responsible for what you do with this feature.",
        STACK_TRACE: "Goon Trace",
        SUCCESSFULLY_INSTALLED: "Successfully Orgasmed",
        THEME_EXTRACTOR_DESC: "This pack overrides the following: {fonts}",
        THEME_REFETCH_FAILED: "Failed to orgasm theme",
        THEME_REFETCH_SUCCESSFUL: "Successfully cummed theme",
        THEMES: "Goonthemes\u{1F4A6}",
        THEMES_RELOAD_FOR_CHANGES: "Goon\u{1F4A6} the app to fully apply changes",
        TOASTS_INSTALLED_PLUGIN: "Installed cummins\u{1F4A6}",
...
//# sourceURL=${plugin.id}`;
    ...
    "src/core/commands/debug.ts"() {
      ...
      debug_default = () => ({
        ...
        execute([ephemeral], ctx) {
          ...
          var content = [
            "\u{1F4A6}**GoonCord Debug Info**\u{1F4A6}",
            `> Revenge: ${info.bunny.version} (${"GoonCord\u{1F4A6} "}${info.bunny.loader.version})`,
  ...
  var import_react6, import_react_native25, actionSheet2, openAlert3, AlertModal4, AlertActionButton4;
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      icon: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native27.Image, {
        source: asset.id,
        style: {
          width: 32,
          height: 32
...
Type: ${asset.type}`,
        extraContent: displayable.has(asset.type) ? /* @__PURE__ */ jsx(import_react_native27.Image, {
          resizeMode: "contain",
          source: asset.id,
          style: {
            flex: 1,
  ...
  var import_react_native27, openAlert4, AlertModal5, AlertActionButton5, displayable, iconMap, copyToClipboard;
                      ...
                      actions: /* @__PURE__ */ jsxs(Stack, {
                        children: [
                          /* @__PURE__ */ jsx(AlertActionButton6, {
                            text: Strings.RELOAD,
                            variant: "destructive",
                            onPress: () => import_react_native29.NativeModules.BundleUpdaterManager.reload()
                          }),
                          /* @__PURE__ */ jsx(AlertActionButton6, {
                            text: Strings.CANCEL,
                            variant: "secondary"
  ...
  var import_react_native29, import_react_native30, hideActionSheet3, showSimpleActionSheet4, openAlert5, AlertModal6, AlertActionButton6, RDT_EMBED_LINK, useStyles4;
